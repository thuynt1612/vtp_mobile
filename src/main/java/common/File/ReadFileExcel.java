...
//                        book.setmanv((String) getCellValue(cell));
//                        break;
//                    case COLUMN_INDEX_TITLE:
//                        book.settennv((String) getCellValue(cell));
//                        break;
//                    case COLUMN_INDEX_QUANTITY:
//                        book.setnhomluong((String) getCellValue(cell));
//                        break;
//                    case COLUMN_INDEX_PRICE:
//                        book.setnamthamnien((Double) getCellValue(cell));
//                        break;
//                    case COLUMN_INDEX_TOTAL:
//                        book.setluongcb((Double) getCellValue(cell));
//                        break;
//                    default:
//                        break;
//                }
